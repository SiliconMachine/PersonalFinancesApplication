<template>
  ...
  <div class="flex h-screen overflow-hidden bg-gray-100">
    ...
    <div
      class="md:hidden"
      v-show="showingResponsivePopOut"
    >
      <div class="fixed inset-0 z-40 flex">
        ...
        <div class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-white">
          <div class="absolute top-0 right-0 p-1 -mr-14">
            <button
              v-on:click="showingResponsivePopOut = false"
          ...
          <div class="flex items-center flex-shrink-0 px-4">
            <jet-application-mark class="block w-auto mx-auto h-9" />
          </div>
          <div class="flex-1 h-0 mt-5 overflow-y-auto">
            <nav class="space-y-1">
              <jet-responsive-nav-link href="/dashboard">
                <svg
                  class="w-6 h-6 mr-4 transition duration-150 ease-in-out text-astronaut-500 group-hover:text-astronaut-500 group-focus:text-astronaut-600"
          ...
          <div class="flex flex-col flex-grow mt-5">
            <nav class="flex-1 space-y-1 bg-white">
              ...
              >
                <!-- Heroicon name: home -->
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-500 group-hover:text-astronaut-500 group-focus:text-astronaut-600"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
              ...
              >
                <!-- Heroicon name: users -->
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-400 group-hover:text-astronaut-500 group-focus:text-astronaut-500"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
              ...
              <jet-nav-link
                href="/goals"
                :active="$page.currentRouteName == 'goals'"
              >
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-400 group-hover:text-astronaut-500 group-focus:text-astronaut-500"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <jet-nav-link
                href="/transactions"
                :active="$page.currentRouteName == 'transactions'"
              >
              ...
              <jet-nav-link
                href="/accounts"
                :active="$page.currentRouteName == 'accounts'"
              >
                <!-- Heroicon name: inbox -->
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-400 group-hover:text-astronaut-500 group-focus:text-astronaut-500"
              ...
              <!-- <jet-nav-link
                href="/tools"
                :active="$page.currentRouteName == 'tools'"
              >
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-400 group-hover:text-astronaut-500 group-focus:text-astronaut-500"
                  fill="none"
              ...
              <jet-nav-link
                href="/admin"
                :active="$page.currentRouteName == 'admin'"
              >
                <svg
                  class="w-5 h-5 transition duration-150 ease-in-out text-astronaut-400 group-hover:text-astronaut-500 group-focus:text-astronaut-500"
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flex flex-col flex-1 w-0 overflow-hidden">
      <div class="relative z-10 flex flex-shrink-0 h-16 bg-white border-b border-blue-gray-200">
        <button
          v-on:click="showingResponsivePopOut = true"
          ...
          <div class="flex flex-1">
            ...
            >
              ...
              <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                ...
                <input
                  id="search_field"
                  class="block w-full h-full py-2 pl-8 pr-3 text-gray-900 placeholder-gray-500 border-0 rounded-md outline-none focus:ring-0 focus:placeholder-gray-400 focus:shadow-none sm:text-sm"
                  placeholder="Search"
                  type="search"
                >
              </div>
            ...
            >
              ...
              <template #content>
                ...
                <!-- <template v-if="$page.props.jetstream.hasTeamFeatures">
                                    ...
                                    <jet-dropdown-link :href="'/teams/' + $page.props.">
                                        Team Settings
                                    </jet-dropdown-link>
