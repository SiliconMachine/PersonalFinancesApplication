      ...
      >
        ...
        >
          <span class="flex items-center px-6 py-4 text-sm font-medium">
            <span class="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-blue-600 rounded-full group-hover:bg-blue-800">
              <CheckIcon
        ...
        <a
          ...
          aria-current="step"
        >
          <span class="flex items-center justify-center flex-shrink-0 w-10 h-10 border-2 border-blue-600 rounded-full">
