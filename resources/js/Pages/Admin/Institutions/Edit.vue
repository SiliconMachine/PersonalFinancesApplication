                    ...
                    <div class="flex items-center">
                      ...
                      <span class="ml-5 rounded-md shadow-sm">
                        <input
                          ...
                          v-on:change="handleInstitutionImageUpload()"
                          accept="image/*"
                          id="institutionImage"
                        ...
                        />
                        <button
                          v-on:click="chooseInstitutionImage()"
                          type="button"
                  ...
                  <div class="flex justify-end">
                    ...
                    <span class="inline-flex ml-3 rounded-md shadow-sm">
                      <button
                        type="button"
                        v-on:click="update()"
                        class="inline-flex justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition duration-150 ease-in-out bg-blue-600 border border-transparent rounded-md hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700"
                      >
                        Update
                      </button>
                    </span>
...
export default {
  ...
  mounted() {
    ...
    this.institutionImagePreview =
      this.institution.logo != "NULL" ? this.institution.logo : false;
    this.showInstitutionImagePreview =
      this.institution.logo != "NULL" ? true : false;
  },
  ...
  methods: {
    update() {
      ...
      this.$inertia.post(
        "/admin/institutions/" + this.institution.id,
        formData
      );
    },
